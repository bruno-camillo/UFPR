...
const renderItem: ListRenderItem<Car> = ({item}) => (
    <View style={[styles.flatlist, {backgroundColor: item.colorhex}]}>
        <Text style={styles.textCar}>{item.modelo}</Text>
        <Text style={styles.textTittleCar}>{item.titulo}</Text>
        ...
        <View style={styles.container}>
            ...
            <View style={styles.subtitulo}>
                <Text style={styles.textSubtitulo}>
                    <Text style={styles.negrito}>Destaques</Text> para você
                </Text>
            </View>
